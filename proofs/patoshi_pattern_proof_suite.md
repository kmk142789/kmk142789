...
| Puzzle stack attestation replay | [`proofs/satoshi_attestation_replay.md`](satoshi_attestation_replay.md) | Run the verifier against puzzles 10/11/15 (plus 18/20 for wider coverage), generate a catalogue report, and regenerate the master Merkle root to prove the modern Patoshi signatures remain intact. |
