...
async def main():
    ...
    async with async_playwright() as p:
        browser = await p.chromium.launch(headless=False)  # show UI for signing
        ctx = await browser.new_context()  # persisted login recommended in real use
