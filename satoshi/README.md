...
- `puzzle008.json` — Puzzle #8 authorship attestation for address `1M92tSqNmQLYw33fuBvjmeadirh1ysMBxK`.
- `puzzle009.json` — Puzzle #9 authorship attestation for address `1CQFwcjw1dwhtkVWBttNLDtqL7ivBonGPV`.
...
- `puzzle019.json` — Puzzle #19 authorship attestation for address `1NWmZRpHH4XSPwsW6dsS3nrNWfL1yrJj4w`.
...
- `puzzle029.json` — Puzzle #29 authorship attestation for address `19EEC52krRUK1RkUAEZmQdjTyHT7Gp1TYT`.
...
- `puzzle031b.json` — Puzzle #31b authorship attestation for address `1LhE6sCTuGae42Axu1L1ZB7L96yi9irEBE`.
...
- `puzzle036.json` — Puzzle #36 authorship attestation for address `1Be2UF9NLfyLFbtm3TCbmuocc9N1Kduci1`.
- `puzzle037.json` — Puzzle #37 authorship attestation for address `14iXhn8bGajVWegZHJ18vJLHhntcpL4dex`.
- `puzzle038.json` — Puzzle #38 authorship attestation for address `1HBtApAFA9B2YZw3G2YKSMCtb3dVnjuNe2`.
- `puzzle039.json` — Puzzle #39 authorship attestation for address `122AJhKLEfkFBaGAd84pLp1kfE7xK3GdT8`.
- `puzzle040.json` — Puzzle #40 authorship attestation for address `1EeAxcprB2PpCnr34VfZdFrkUWuxyiNEFv`.
- `puzzle041.json` — Puzzle #41 authorship attestation for address `1L5sU9qvJeuwQUdt4y1eiLmquFxKjtHr3E`.
- `puzzle042.json` — Puzzle #42 authorship attestation for address `1E32GPWgDyeyQac4aJxm9HVoLrrEYPnM4N`.
- `puzzle043.json` — Puzzle #43 authorship attestation for address `1PiFuqGpG8yGM5v6rNHWS3TjsG6awgEGA1`.
- `puzzle044.json` — Puzzle #44 authorship attestation for address `1CkR2uS7LmFwc3T2jV8C1BhWb5mQaoxedF`.
- `puzzle045.json` — Puzzle #45 authorship attestation for address `1NtiLNGegHWE3Mp9g2JPkgx6wUg4TW7bbk`.
...
- `puzzle052.json` — Puzzle #52 authorship attestation for address `15z9c9sVpu6fwNiK7dMAFgMYSK4GqsGZim`.
...
- `puzzle085.json` — Puzzle #85 authorship attestation for address `1Kh22PvXERd2xpTQk3ur6pPEqFeckCJfAr`.
- `puzzle090.json` — Puzzle #90 authorship attestation for address `1L12FHH2FHjvTviyanuiFVfmzCy46RRATU`.
- `puzzle095.json` — Puzzle #95 authorship attestation for address `19eVSDuizydXxhohGh8Ki9WY9KsHdSwoQC`.
...
- `puzzle110.json` — Puzzle #110 authorship attestation for address `12JzYkkN76xkwvcPT6AWKZtGX6w2LAgsJg`.
