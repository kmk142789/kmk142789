"""Verification script for COLOSSUS cycle 00001."""
...
def load_dataset() -> dict:
    path = Path(__file__).resolve().with_name("dataset_cycle_00001.json")
...
def main() -> None:
    ...
    lineage_path = Path(__file__).resolve().with_name("lineage_map_00001.json")
    if not lineage_path.exists():
        raise SystemExit("Lineage map missing for this cycle.")

    print("Cycle 00001 verification successful.")
