"""Verification script for COLOSSUS cycle 00002."""
...
def load_dataset() -> dict:
    path = Path(__file__).resolve().with_name("dataset_cycle_00002.json")
...
def main() -> None:
    ...
    lineage_path = Path(__file__).resolve().with_name("lineage_map_00002.json")
    if not lineage_path.exists():
        raise SystemExit("Lineage map missing for this cycle.")

    print("Cycle 00002 verification successful.")
