...
- **Trust alignment** – fails fast if the configured `VC_ISSUER_DID` does not match the trust registry issuer and exposes the
  currently loaded registry at `/trust/registry`.
